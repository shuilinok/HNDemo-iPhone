//
//  UITapGestureRecognizer+EventHook.m
//
//  Created by matelin on 2019/7/5.
//  Copyright © 2019 闪电降价. All rights reserved.
//

#import "UITapGestureRecognizer+EventHook.h"
#import "EventPathHelper.h"
#import <objc/runtime.h>

@implementation UITapGestureRecognizer (EventHook)
...
- (void)custom_touchesEnded:(NSSet*)touches withEvent:(UIEvent*)event {
    ...
    for(UITouch *touch in touches) {
        ...
        NSLog(@"位置：%@，类型：%ld，处理者：%@", path, (long)touch.phase, NSStringFromClass([self.view class]));
    }
